(function() {
  ...
  describe('on report page', function() {
    var date = new Date();
    beforeAll(function() {
      browser.wait(testUtils.until.presenceOf(mainReportPage.getWorkingTime()));
    });
    ...
    describe('check report list', function() {
      it('should have working time report', function() {
        expect(mainReportPage.getWorkingTime().isPresent()).toBeTruthy();
      });
    });

    describe('check working time report', function() {
      beforeAll(function() {
        mainReportPage.clickWorkingTime();
      ...
      describe('check elements', function() {
        it('should have report title', function() {
          expect(mainReportPage.getReportTitle().getText()).toEqual('Working time');
        });
        ...
        it('should have select workers label', function() {
          expect(mainReportPage.getReportControlList().get(5).element(by.css('label')).getText()).toEqual('Select workers');
        });
