  ...
  describe('on report view ', function() {
    ...
    describe('check journeys card ', function() {
      beforeAll(function() {
        ...
        browser.wait(testUtils.until.presenceOf(element(by.css('ul[aria-hidden="false"] li:nth-child(4)'))));
        browser.executeScript("arguments[0].click();", element(by.css('ul[aria-hidden="false"] li:nth-child(4)')).getWebElement());
      ...
      it('should have arrival location', function() {
        reportListPage.getSelectedTotalDayRow().element(by.css('div:nth-child(3).medium-3 div:nth-child(2).medium-4')).getText().then(function(text) {
